...
if __name__ == "__main__":
    ...
    parser.add_argument('result_path', nargs='?', default='/Users/nirheaven/Downloads/BAAI_3_submit_result.jsonl',
    ...
    parser.add_argument('-c', '--contest',
                        help='Contest ID, if not specified, the global CONTEST variable will be used', default='1780211530478944282')
    parser.add_argument('-k', '--ticket',
                        help='Submission ticket, if not specified, the global TICKET variable will be used', default='1791340293841256473')
    parser.add_argument('-i', '--submission_id',
                        help='Submission ID, specified if you want to check the submission status', default=1718540280308)
